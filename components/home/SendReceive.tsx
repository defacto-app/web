    ...
    <div>
      <div className="relative bg-white">
        <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          <div className="px-6 pb-10 pt-10 sm:pb-20 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
              ...
              <div className="">
                <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                  ...
                  >
                    ...
                    Try Defacto <span aria-hidden="true">&rarr;</span>
                  </a>
                </div>
              </div>
              <h1 className="mt-24 text-4xl font-bold tracking-tight  sm:mt-10 sm:text-6xl">
                Send & Receive Package Swiftly with{" "}
                <span className="text-primary-500"> Defacto</span>
              </h1>
