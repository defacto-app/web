...
export const AllRestaurantLoading = () => {
	return (
		<div className="pt-4 pb-20 container mx-auto">
	...
	return (
		<div className="flex flex-col items-center justify-center py-16 px-4 text-center">
			...
			<p className="text-gray-600 max-w-md">
				We couldn't find any restaurants matching your search . Try adjusting
				your search terms or browse our available restaurants.
			</p>
		</div>
	);
};
